...
JU = {
    ...
    'E': function (Ju,) {
        let fC=U;
        let Jb = 0;
        let JP = J[fC(PX.J3)](J[fC(PX.J4)](J[fC(PX.J5)](J[fC(PX.J6)](J[fC(PX.J7)](JU[fC(PX.J8)](Ju), '|'), 0), '|'), new Date()["getTime"]()), '|1')
        return Jf['ua'](JP, true)
    },
}
function get_type(Jk) {
        // let params = JSON.parse(params0)
        // let province = encodeURIComponent(params.province)
        // let industry = encodeURIComponent(params.industry)
        // let Jk = `https://ctbpsp.com/cutominfoapi/recommand/type/${params.type1}/pagesize/10/currentpage/${params.currentpage}?province=${province}&industry=${industry}`
    let Jw = function (Jd, JP) {
        return JU['E'](Jd, JP);
    }
...
// let params = "https://ctbpsp.com/cutominfoapi/recommand/type/0/pagesize/10/currentpage/3?province=%E5%8C%97%E4%BA%AC&industry=%E5%85%AC%E8%B7%AF"
// console.log(get_type(params))