...
!function (g) {
    ...
    r2 = {
        ...
        e2 = {},
        i2 = function e(t) {
            // console.log("Loading module with ID:", t); // 打印模块 ID
            var n = e2[t];
            if (!n) {
                // console.log("Initializing module", t); // 打印模块初始化
                n = e2[t] = {
                    exports: {}
                };
                // console.log("t:::", t); // 打印工厂函数
                r2[t][0].call(n, e, n, n.exports);
            }
            // console.log("Module", t, "exports:", n.exports); // 打印模块导出内容
            return n.exports;
        }(16);
    commonjsGlobal.i2 = i2
