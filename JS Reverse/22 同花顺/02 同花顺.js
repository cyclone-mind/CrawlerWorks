...
Object.defineProperties(Navigator.prototype, {
  userAgent: {get(){ v_console_log("  [*] Navigator -> userAgent[get]", "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/128.0.0.0 Safari/537.36");return "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/128.0.0.0 Safari/537.36" }},
...
Object.defineProperties(PerformanceTiming.prototype, {
  domainLookupEnd: {get(){ v_console_log("  [*] PerformanceTiming -> domainLookupEnd[get]", 1726569915241);return 1726569915241 }},
  domainLookupStart: {get(){ v_console_log("  [*] PerformanceTiming -> domainLookupStart[get]", 1726569915241);return 1726569915241 }},
  connectEnd: {get(){ v_console_log("  [*] PerformanceTiming -> connectEnd[get]", 1726569915241);return 1726569915241 }},
  connectStart: {get(){ v_console_log("  [*] PerformanceTiming -> connectStart[get]", 1726569915241);return 1726569915241 }},
  responseStart: {get(){ v_console_log("  [*] PerformanceTiming -> responseStart[get]", 1726569915261);return 1726569915261 }},
  requestStart: {get(){ v_console_log("  [*] PerformanceTiming -> requestStart[get]", 1726569915247);return 1726569915247 }},
  navigationStart: {get(){ v_console_log("  [*] PerformanceTiming -> navigationStart[get]", 1726569915241);return 1726569915241 }},
...
Object.defineProperties(DOMRectReadOnly.prototype, {
  top: {get(){ v_console_log("  [*] DOMRectReadOnly -> top[get]", 17.997684478759766);return 17.997684478759766 }},
  left: {get(){ v_console_log("  [*] DOMRectReadOnly -> left[get]", 913.0786743164062);return 913.0786743164062 }},
...
Object.defineProperties(SVGRect.prototype, {
  ...
  y: {get(){ v_console_log("  [*] SVGRect -> y[get]", -9.259259223937988);return -9.259259223937988 }},
  width: {get(){ v_console_log("  [*] SVGRect -> width[get]", 16.695602416992188);return 16.695602416992188 }},
  height: {get(){ v_console_log("  [*] SVGRect -> height[get]", 11.11111068725586);return 11.11111068725586 }},
...
Object.defineProperties(Event.prototype, {
  ...
  timeStamp: {get(){ v_console_log("  [*] Event -> timeStamp[get]", 31507.099999904633);return 31507.099999904633 }},
...
Object.defineProperties(Screen.prototype, {
  width: {get(){ v_console_log("  [*] Screen -> width[get]", 1778);return 1778 }},
  height: {get(){ v_console_log("  [*] Screen -> height[get]", 1000);return 1000 }},
...
Object.defineProperties(Element.prototype, {
  ...
  className: {get(){ v_console_log("  [*] Element -> className[get]", "arr-trigger arr-trigger-hover");return "arr-trigger arr-trigger-hover" },set(){ v_console_log("  [*] Element -> className[set]", [].slice.call(arguments));return "arr-trigger arr-trigger-hover" }},
  ...
  clientWidth: {get(){ v_console_log("  [*] Element -> clientWidth[get]", 1762);return 1762 }},
  clientHeight: {get(){ v_console_log("  [*] Element -> clientHeight[get]", 2181);return 2181 }},
...
Object.defineProperties(HTMLElement.prototype, {
  ...
  offsetWidth: {get(){ v_console_log("  [*] HTMLElement -> offsetWidth[get]", 216);return 216 }},
...
init_cookie("v=AzTR7-MQ7o4QJnpCI1TH6kZlBfmkDVj3mjHsO86VwL9COdon9h0oh-pBvM0d")
...
function v_geteles(name, func){
  if(name == "*" && func == "getElementsByTagName"){ return [v_new(HTMLElement)] }
  ...
  if(name == "sizcache004275538102292953" && func == "getElementsByName"){ return [] }
  ...
  if(name == "[id='sizcache004275538102292953'] .m-pager-board a[board]" && func == "querySelectorAll"){ return [v_new(HTMLAnchorElement),v_new(HTMLAnchorElement),v_new(HTMLAnchorElement),v_new(HTMLAnchorElement),v_new(HTMLAnchorElement),v_new(HTMLAnchorElement)] }
  if(name == "m-pager-table" && func == "getElementsByClassName"){ return [v_new(HTMLTableElement),v_new(HTMLTableElement)] }
  if(name == "[id='sizcache004275538102292953'] a[field]" && func == "querySelectorAll"){ return [v_new(HTMLAnchorElement),v_new(HTMLAnchorElement),v_new(HTMLAnchorElement),v_new(HTMLAnchorElement),v_new(HTMLAnchorElement),v_new(HTMLAnchorElement),v_new(HTMLAnchorElement),v_new(HTMLAnchorElement),v_new(HTMLAnchorElement),v_new(HTMLAnchorElement),v_new(HTMLAnchorElement)] }
  if(name == "[id='sizcache004275538102292953'] .m-pager a[page]" && func == "querySelectorAll"){ return [v_new(HTMLAnchorElement),v_new(HTMLAnchorElement),v_new(HTMLAnchorElement),v_new(HTMLAnchorElement),v_new(HTMLAnchorElement),v_new(HTMLAnchorElement),v_new(HTMLAnchorElement)] }
  if(name == "[id='sizcache004275538102292953'] .m-pager-board .cur a[board]" && func == "querySelectorAll"){ return [v_new(HTMLAnchorElement)] }
  if(name == "[id='sizcache004275538102292953'] .m-pager-table .cur a[field]" && func == "querySelectorAll"){ return [v_new(HTMLAnchorElement),v_new(HTMLAnchorElement)] }
  if(name == "[id='sizcache004275538102292953'] .m-pager a.cur" && func == "querySelectorAll"){ return [v_new(HTMLAnchorElement)] }
  if(name == ".hcharts-list .item" && func == "querySelectorAll"){ return [v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement)] }
  if(name == "[id='sizcache004275538102292953'] .detail span.c-rise" && func == "querySelectorAll"){ return [v_new(HTMLSpanElement)] }
  if(name == "[id='sizcache004275538102292953'] .detail span.c-fall" && func == "querySelectorAll"){ return [v_new(HTMLSpanElement)] }
  if(name == "tspan" && func == "getElementsByTagName"){ return [v_new(SVGTSpanElement)] }
  if(name == "[id='sizcache004275538102292953'] .detail span" && func == "querySelectorAll"){ return [v_new(HTMLSpanElement)] }
  ...
  if(name == ".sub-nav[data-type=bk]" && func == "querySelectorAll"){ return [v_new(HTMLDivElement)] }
  if(name == ".arr-trigger[data-type=bk]" && func == "querySelectorAll"){ return [v_new(HTMLAnchorElement)] }
  return null
}
var v_Date = Date;
